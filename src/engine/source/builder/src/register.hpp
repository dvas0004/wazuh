...
void registerOpBuilders(const std::shared_ptr<Registry>& registry, const BuilderDeps& deps)
{
    ...
    registry->template add<builders::OpBuilderEntry>(
        ...
        {schemf::JTypeToken::create(json::Json::Type::Number), builders::opBuilderHelperIanaProtocolNameToNumber});
    registry->template add<builders::OpBuilderEntry>(
        "iana_protocol_number_to_name",
        {schemf::JTypeToken::create(json::Json::Type::String), builders::opBuilderHelperIanaProtocolNumberToName});
    registry->template add<builders::OpBuilderEntry>(
        "ip_version",
